...
eval("const { registerEventHandlers, handleResizeCanvasEvent } = __webpack_require__(/*! ./util/registerEventHandlers */ \"./src/util/registerEventHandlers.js\");\nconst getCanvasTag = __webpack_require__(/*! ./util/getCanvasTag */ \"./src/util/getCanvasTag.js\");\nconst renderCanvasFrame = __webpack_require__(/*! ./util/renderCanvasFrame */ \"./src/util/renderCanvasFrame.js\");\n\n(function() {\n  // Prepare initial canvas tag\n  const canvas = getCanvasTag();\n\n  // Dynamically append tag to page body\n  document.body.appendChild(canvas);\n\n  // Set initial canvas size\n  handleResizeCanvasEvent(canvas);\n\n  // Prepare event listeners for click & resize events\n  registerEventHandlers(canvas);\n\n  // Begin core rendering loop\n  renderCanvasFrame(canvas, canvas.getContext('2d'));\n})();\n\n\n//# sourceURL=webpack:///./src/index.js?");
...
/***/ "./src/util/registerEventHandlers.js":
/*!*******************************************!*\
  !*** ./src/util/registerEventHandlers.js ***!
  \*******************************************/
/*! no static exports found */
